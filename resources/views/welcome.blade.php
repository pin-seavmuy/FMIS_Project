...
<body>
    ...
    <div class="landing" id="landing-page">
        <button class="theme-toggle" id="theme-toggle" aria-label="Toggle theme">
            <svg id="theme-icon-light" class="theme-icon" xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <svg id="theme-icon-dark" class="theme-icon" xmlns="http://www.w3.org/2000/svg" width="16"
                height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="landing-content">
            ...
            <p class="landing-desc">Sign in with your SMIS account to access the dashboard, manage data, and view
                reports.</p>
